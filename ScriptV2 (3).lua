...
-- code by HNC
--[[
    Abacaxi Hub Source - Remake By Dark X 
...
Bindable.OnInvoke = function(button)
    if button == "Copy Link" then
        ...
        if setclipboard then
            setclipboard("https://discord.gg/sC6zk7EhCa")
        end
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Dark X Hub Có On Top Không !",
    Text = "Có Không?",
    Duration = 10,
    Button1 = "Có",
    Button2 = "Có",
...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://pastefy.app/cgRXe9Xh/raw"))():MakeWindow({
    Title = "Dark X Hub [ Freemium ]",
    SubTitle = "By Dark X Hub Team",
